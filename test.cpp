    ...
    public:
        ...
        void add_entity(GridEntity new_entity)
        {
            ...
            */
            ...
            //cout << "x boundaries: " << x_boundary_left << ", " << x_boundary_right << "\n";
            //cout << "y boundaries: " << y_boundary_top << ", " << y_boundary_bottom << "\n";
            //cout << "cell width pixels: " << cell_width_pixels << "\n";
            ...
            //cout << "before: " << left_column_index_boundary << "\n";
            ...
            cout << "top_row_index_boundary: " << top_row_index_boundary << "\n";
            cout << "bottom_row_index_boundary: " << bottom_row_index_boundary << "\n";
            cout << "left_column_index_boundary: " << left_column_index_boundary << "\n";
            cout << "right_column_index_boundary: " << right_column_index_boundary << "\n";
            ...
            cout << "col amount: " << columns_amount << "\n";
            cout << "top_row_index_boundary: " << top_row_index_boundary << "\n";
            cout << "bottom_row_index_boundary: " << bottom_row_index_boundary << "\n";
            cout << "left_column_index_boundary: " << left_column_index_boundary << "\n";
            cout << "right_column_index_boundary: " << right_column_index_boundary << "\n";
            ...
            for (int row_index = top_row_index_boundary; row_index <= bottom_row_index_boundary; row_index++)
            {
                ...
                {
                    cout << "There it is: " << cells[row_index][col_index].get_entities_counter();
...
int main()
{
    ...
    //MyGif test_gif = MyGif(PATH_FISH1, Location(2500, 400), Size(500, 500), 1, 0, true, 5, new Cell[5]);
    ...
    // Create the grid.
    Grid grid = Grid(5, 3, FISH_POPULATION, world1.width, world1.height);
